...
# translation
SOURCES = surfacearea.py ui_surfacearea.py __init__.py surfaceareadialog.py
#TRANSLATIONS = i18n/surfacearea_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = surfacearea

PY_FILES = surfacearea.py surfaceareadialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_surfacearea.py
